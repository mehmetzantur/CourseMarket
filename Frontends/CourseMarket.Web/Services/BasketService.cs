...
namespace CourseMarket.Web.Services
{
    public class BasketService : IBasketService
    {
        ...
        public async Task AddBasketItem(BasketItemViewModel itemViewModel)
        {
            var basket = await Get();
            if (basket != null)
            {
                if (!basket.BasketItems.Any(x => x.CourseId == itemViewModel.CourseId))
                {
                    basket.BasketItems.Add(itemViewModel);
                }
            }
            else
            {
